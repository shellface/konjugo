...
// 'L1' — explicit case label chip. 'L2' — preposition trigger, no nominative.
// 'context' — no explicit label at all: a preposition trigger disambiguates
// acc/dat/gen, and its absence (bare phrase) implicitly reads as nominative.
export type CueMode = 'L1' | 'L2' | 'context';
